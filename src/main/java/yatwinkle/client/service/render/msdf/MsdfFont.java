package yatwinkle.client.service.render.msdf;
...
import yatwinkle.client.service.render.msdf.FontData.AtlasData;
import yatwinkle.client.service.render.msdf.FontData.GlyphData;
import yatwinkle.client.service.render.msdf.FontData.MetricsData;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public MsdfFont.Builder data(String dataFileName) {
			this.dataIdentifer = Identifier.of("yatwinkle", "fonts/" + dataFileName + ".json");
			return this;
		}
		
		public MsdfFont.Builder atlas(String atlasFileName) {
			this.atlasIdentifier = Identifier.of("yatwinkle", "fonts/" + atlasFileName + ".png");
			return this;
		}
